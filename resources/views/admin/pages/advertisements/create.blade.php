...
@section('content')
    <div class="container-fluid">
        ...
        @include('admin.pages.partials.back_arrow',['backRoute' => route('admin.ads.index'),'text' => 'Add New Advertisement'])
        @if (session('status'))
...
{{--                    <label class="col-sm-2 col-form-label">Segment Type</label>--}}
{{--                    <div class="col-sm-10">--}}
{{--                        <div class="form-check form-check-inline">--}}
{{--                            <input class="form-check-input" type="radio" name="location_type" id="location_type_1" value="1" {{old('location_type') == 1 ? 'checked' : ''}} required>--}}
{{--                            <label class="form-check-label" for="location_type_1">Virgin Island</label>--}}
{{--                        </div>--}}
{{--                        <div class="form-check form-check-inline">--}}
{{--                            <input class="form-check-input" type="radio" name="location_type" id="location_type_2" value="2" {{old('location_type') == 2 ? 'checked' : ''}} required>--}}
{{--                            <label class="form-check-label" for="location_type_2">Caribbean</label>--}}
{{--                        </div>--}}

{{--                        <div class="form-check form-check-inline">--}}
{{--                            <input class="form-check-input" type="radio" name="location_type" id="location_type_3" value="3" {{old('location_type') == 3 ? 'checked' : ''}} required>--}}
{{--                            <label class="form-check-label" for="location_type_3">Both</label>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    @include('admin.components.error',['error' => 'location_type'])--}}
{{--                </div>--}}
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="page" class="form-control" id="page">
                            ...
                            @foreach(getPagesForAdvertisementFilter() as $page)
                                <option value="{{$page['page']}}" {{old('page') == $page['page'] ? 'selected' : ''}}>{{$page['page']}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check form-check-inline ads_type">
                            <input class="form-check-input" type="radio" name="type" id="custom" value="0" {{old('type') == 0 ? 'checked' : ''}} required>
                            <label class="form-check-label" for="custom">Custom Ad</label>
                        </div>
                        <div class="form-check form-check-inline ads_type">
                            <input class="form-check-input" type="radio" name="type" id="google" value="1" {{old('type') == 1 ? 'checked' : ''}} required>
                ...
                <div class="form-group row" id="redirect_url_div">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="redirect_url" id="redirect_url" value="{{old('redirect_url')}}" placeholder="Redirect Url" required>
                    ...
                    <div id="image-container" class="text-center mb-5 d-flex  w-100">
                        ...
                        <div class=" border-dashed p-10 col-sm-10">
                            <div class="flex-column">
                                <img width="400px" id="image_preview" class="object-cover img-space" onerror="this.onerror=null; this.src=this.style.display = 'none'" src="{{old('advertisement_pic')}}" alt="Advertisement Image">
                            </div>
                            ...
                            <input id="advertisement_pic"  name="advertisement_pic" type="file"  accept="image/png,image/jpg,image/jpeg,image/webp,image/gif    "  class="d-none" />
                ...
                <div class="form-group row" style="display: none;" id="ad_script">
                    ...
                    <div class="col-sm-10">
                        <textarea rows="5" class="form-control" name="advertisement_script" id="advertisement_script"  placeholder="Google Advertisement script" >{{old('advertisement_script')}}</textarea>
        ...
        $(document).ready(function() {
            ...
            $(document).on("change","#page", function(event) {
                ...
                $.ajax({
                    url,
                    method: 'POST',
                    data: { "_token": "{{ csrf_token() }}",'page':page,'location_type':location_type },
