...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-2 text-gray-800">Manage Obituary</h1>
        @if (session('status'))
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Virgin Islands Obituary</a>
                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Caribbean Obituary</a>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                @include('admin.pages.obituaries.datatable',['id' => 'datatable1'])
            </div>
            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                @include('admin.pages.obituaries.datatable',['id' => 'datatable2'])
            </div>
        </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function toggleActivity(e,column = 'is_breaking_news'){
            ...
            url = '/admin/obituaries/'+itemId+'/toggle';
            Swal.fire({
                // title: 'Are you sure?',
        ...
        function initializeDatatable(tableId,newsTypeId = null){
             url = `/admin/obituaries/datatable/`
            if (newsTypeId != null){
                url += newsTypeId
            }
            $(`#${tableId}`).DataTable({
                ...
                columns: [
                    ...
                    { data: 'content',name:'description',width: '10%'},
                    { data: 'thumbnail',width: '10%'},
                    { data: 'payment_status',width: '10%'},
                    { data: 'phone_number',name:'contact number',width: '10%'},
