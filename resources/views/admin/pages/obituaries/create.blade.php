...
@section('content')
    <div class="container-fluid">
        @include('admin.pages.partials.back_arrow',['backRoute' => route('admin.obituaries.index'),'text' => 'Add New Obituary'])
        @include('admin.components.errors')
        <form method="post" action="{{ route('admin.obituaries.store') }}"  enctype="multipart/form-data">
            @csrf
            <div class="col-lg-9">
