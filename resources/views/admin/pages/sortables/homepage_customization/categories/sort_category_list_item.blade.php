...
{{--    <div class="w-100">--}}
{{--        <div class="form-group row">--}}
{{--            <select name="ui_type" class="form-control select2">--}}
{{--                <option value=""> Select UI</option>--}}
{{--                @foreach($uiTypes  as $uiType)--}}
{{--                    <option value="{{$uiType}}" {{$categoryOrder->ui_type == $uiType ? 'selected' : ''}}>UI {{$uiType}}</option>--}}
{{--                @endforeach--}}
{{--            </select>--}}
{{--            @include('admin.components.error',['error' => 'ui_type'])--}}
{{--        </div>--}}
{{--    </div>--}}
