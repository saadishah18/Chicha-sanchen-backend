...
@section('content')
    <div class="container-fluid">
        ...
        @include('admin.pages.partials.back_arrow',['backRoute' => route('admin.videos.index'),'text' => 'Edit Video'])
        <form method="post" action="{{ route('admin.videos.update',['id' => $video->content_id]) }}"  enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="col-lg-9">
