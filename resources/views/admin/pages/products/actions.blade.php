<a title="Edit user" href="{{ route('admin.products.edit', ['id' => $product->id]) }}" class="btn btn-info btn-circle">
    <i class="fas fa-pencil-alt"></i>
</a>

<a title="{{ $product->is_featured == 1 ? 'Featured' : 'Featur' }} user" data-id="{{ $product->id }}" href="#"
...
<a title="{{ $product->is_active ? 'Deactive' : 'Active' }} user" data-id="{{ $product->id }}" href="#"
