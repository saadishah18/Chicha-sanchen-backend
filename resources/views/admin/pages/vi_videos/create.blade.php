...
@section('content')
    <div class="container-fluid">
        ...
        @include('admin.pages.partials.back_arrow',['backRoute' => route('admin.vi_videos.index'),'text' => 'Add new video'])
        <form method="post" action="{{ route('admin.vi_videos.store') }}"  enctype="multipart/form-data">
            @csrf
            <div class="col-lg-9">
