...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card-header py-3">
            @can('create_vic_regional_news')
                <a href="{{ route('admin.vi_videos.create') }}" class="btn btn-info btn-icon-split">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="tab1">
                @include('admin.pages.vi_videos.datatable', ['id' => 'datatable1'])
            </div>
        </div>
...
@section('js')
    ...
    <script type="text/javascript">
        function toggleActivity(e, column = 'is_breaking_news') {
            ...
            url = '/admin/vi-videos/' + itemId + '/toggle';
            Swal.fire({
                // title: 'Are you sure?',
