...
//        dd($this, AddOn::find($this->parent_add_on_id), AddOn::find($this->child_add_on_id));
        return [
//            'order_id' => $this->order_id,
//            'order_item_id' => $this->order_item_id,
//            'product_id' => $this->product_id,
            'parent_add_on_id' => $this->parent_add_on_id,
            'parent_add_on_name' => $this->parent_add_on_id != null ? AddOn::find($this->parent_add_on_id) ? AddOn::find($this->parent_add_on_id)->name : null : null,
            'child_add_on_id' => $this->child_add_on_id,
            'child_add_on_name' => $this->child_add_on_id != null ? AddOn::find($this->child_add_on_id) ? AddOn::find($this->child_add_on_id)->name :null : null,
